...
public class PlayerSelectScreen extends JPanel {
    ...
    public PlayerSelectScreen(MainWindow mw) {
        ...
        add(uc);
        String sOpcion1 = "1 Player(Default)";

        //set up radio buttons
        opt1 = new JRadioButton(sOpcion1);
        opt1.setSelected(true);
        String sOpcion2 = "2 Players";

        opt2 = new JRadioButton(sOpcion2);
        String sOpcion3 = "3 Players";
        opt3 = new JRadioButton(sOpcion3);
